        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionOperations_WorkOrders_WorkOrderId",
            ...
            migrationBuilder.CreateTable(
                name: "OperationWorkforces",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OperationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    WorkforceId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    HoursWorked = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationWorkforces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OperationWorkforces_ProductionOperations_OperationId",
                        column: x => x.OperationId,
                        principalTable: "ProductionOperations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OperationWorkforces_Workforces_WorkforceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationWorkforces_OperationId",
                table: "OperationWorkforces",
                column: "OperationId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationWorkforces_WorkforceId",
                table: "OperationWorkforces",
                column: "WorkforceId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionOperations_WorkOrderId",
